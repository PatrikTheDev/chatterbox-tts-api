...
from app.api.endpoints import speech, health, models, memory, config, status, voices, diagnostics
...
api_router.include_router(diagnostics.router, tags=["Performance Diagnostics"]) 